...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      "O calendário de 21 dias que você imprime e pendura na geladeira",
      "Os primeiros 7 dias já planejados — você só segue",
      "Lista de compras da semana pronta. Sem improvisar no mercado.",
      "Checklist diário pra marcar com caneta",
      "Trocas inteligentes pra quando bater vontade do errado",
      "10 atalhos pra não parar no meio do caminho",
    ],
    highlighted: false,
    ctaLabel: "QUERO MEU CALENDÁRIO",
  },
  {
    id: "completo",
    name: "Kit Detox",
    ...
    features: [
      ...
      "O calendário físico A3 — o que você pendura na geladeira de verdade",
      "Um guia pra os dias em que a cabeça pesa mais que o corpo",
      "Planner mensal pra continuar quando os 21 dias acabarem",
      "Grupo no WhatsApp por 30 dias — outras mulheres marcando junto com você",
    ],
    highlighted: true,
  ...
  },
  {
    ...
    features: [
      ...
      "Um e-mail seu por dia, durante 21 dias — como se alguém te lembrasse",
      "Diário pra escrever o que você sentiu — pra olhar daqui a 6 meses",
      "O app fica com você pra sempre. Não tem prazo pra continuar.",
    ],
    highlighted: false,
