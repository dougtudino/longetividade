    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Google OAuth */}
          <a
            href="/api/auth/google/start?context=admin"
            className="flex w-full items-center justify-center gap-3 rounded-lg py-3 text-sm font-semibold transition-colors"
            style={{
              background: "var(--bg-secondary)",
              color: "var(--text-primary)",
              border: "0.5px solid var(--border-default)",
