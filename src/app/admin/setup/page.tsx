          ...
          <table style={{ width: "100%", fontSize: 11, borderCollapse: "collapse" }}>
            ...
            <tbody>
              {[
                ...
                { name: "Luna Trends", path: "/api/cron/social-trends", cron: "0 22 * * 6", note: "Sab 19h BRT — websearch Claude" },
                { name: "Luna Plan Week (draft)", path: "/api/cron/social-plan-week", cron: "0 22 * * 0", note: "Dom 19h BRT — gera semana em draft pra revisar" },
                { name: "Luna Generate", path: "/api/cron/social-generate", cron: "0 23 * * 0", note: "Dom 20h BRT — usa trends+calendar+bank (approved)" },
