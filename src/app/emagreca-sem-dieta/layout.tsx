...
export const metadata: Metadata = {
  ...
  description:
    "Perca peso de forma permanente sem passar fome. O Metodo SEM transforma sua relacao com a comida com 3 pilares cientificos. De R$97 por R$37.",
  openGraph: {
    title: "Emagreca Sem Dieta — Metodo SEM | De R$97 por R$37",
    description:
