  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
        ...
        {/* Google OAuth */}
        <a
          href="/api/auth/google/start?context=app"
          className="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white py-3.5 text-base font-semibold text-gray-700 transition-colors hover:bg-gray-50"
        >
