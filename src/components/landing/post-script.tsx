  ...
  return (
    <section className="py-12 md:py-20 bg-cream-white">
      <div className="mx-auto max-w-xl px-4">
        <div className="font-body text-charcoal text-base md:text-lg leading-[1.8] italic space-y-6">
          <p>
            <strong className="not-italic">P.S.</strong> -- Se voce esta
          ...
          <p>
            <strong className="not-italic">P.P.S.</strong> -- Lembre-se: voce
            tem 7 dias de garantia. Se nao gostar, devolvo seu dinheiro. O unico
            risco e nao tentar.
          </p>
        </div>
