const PILLARS = [
  {
    icon: (
      <svg className="w-12 h-12 text-olive" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  return (
    <section className="py-12 md:py-20 bg-white">
      <div className="mx-auto max-w-5xl px-4">
        <h2 className="font-heading font-bold text-charcoal text-2xl md:text-4xl text-center mb-2">
          Conheca o Metodo S.E.M
        </h2>
        <p className="font-body text-dark-gray text-lg md:text-xl text-center mb-10 md:mb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {PILLARS.map((pillar) => (
            <div
              key={pillar.title}
              className="bg-sage-light rounded-2xl p-6 md:p-8 transition-shadow hover:shadow-lg"
            >
              <div className="mb-4">{pillar.icon}</div>
              <p className="font-body text-sage text-xs uppercase tracking-widest mb-1">
                {pillar.subtitle}
              </p>
              <h3 className="font-body font-bold text-olive text-xl mb-3">
                {pillar.title}
              </h3>
              <p className="font-body text-dark-gray text-sm md:text-base leading-relaxed">
                {pillar.description}
              </p>
            </div>
          ))}
        ...
        <p className="font-body text-charcoal text-base md:text-lg text-center mt-10 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="text-center mt-8">
          <a
            href="#pricing"
            className="inline-block bg-sage hover:bg-olive text-white font-body font-bold text-base px-8 py-4 rounded-xl transition-colors"
          >
